            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {steps.map((step, index) => (
                        <div key={index} className="bg-white rounded-3xl border border-sage-100 p-8 lg:p-10 shadow-[0_30px_60px_-15px_rgba(167,185,169,0.4),0_10px_30px_-10px_rgba(167,185,169,0.2)] flex flex-col h-full transform transition-all hover:-translate-y-2 duration-300">
                            {/* Step Header */}
